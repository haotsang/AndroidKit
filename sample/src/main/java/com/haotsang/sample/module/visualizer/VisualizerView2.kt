...
class VisualizerView2(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    init {
        ...
        mLineWidth =  5
        mBaseHeight =  1
        mLineIsSingleColor =  true
        mFirstPartColor =  Color.parseColor("#FFFFFF")
        mSecondPartColor =  Color.parseColor("#FFFFFF")
        mThirdPartColor =  Color.parseColor("#FFFFFF")
        mFourthPartColor = Color.parseColor("#FFFFFF")
        init()
    }
