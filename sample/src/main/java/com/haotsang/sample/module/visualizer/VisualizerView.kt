...
class VisualizerView : View {
    ...
    private fun setStyle(upShowStyle: ShowStyle) {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        when (upShowStyle) {
            ShowStyle.STYLE_HOLLOW_LUMP -> setStyle(ShowStyle.STYLE_WAVE)
            ShowStyle.STYLE_WAVE -> setStyle(ShowStyle.STYLE_NOTHING)
            ShowStyle.STYLE_NOTHING -> setStyle(ShowStyle.STYLE_HOLLOW_LUMP)
        }
